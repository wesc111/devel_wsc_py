...
Install directories are added to the $PATH variable.
...
Basically, jupyter always takes the path at which it was started as root, so you can start it with a sequence of 
```
cd C:\Users\werne\OneDrive\devel_werner_2025\python
jupyter lab
```
That opens a notebook
